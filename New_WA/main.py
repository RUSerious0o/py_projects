...
wizard = Wizard()
bear = Bear()
# first_encounter_area = EncounterArea([Bear(), Spider(), Mantis()])
# second_encounter_area = EncounterArea([Wasp(), Elephant()], (600, 400))
# third_encounter_area = EncounterArea([Elephant(), Spider(), Cat(), Cockroach()], (0, 400))
# forth_encounter_area = EncounterArea([Turtle(), Thunder()], (600, 0))
